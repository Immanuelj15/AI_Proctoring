  ...
  return (
    <div className="auth-card" style={{ maxWidth: "460px" }}>
      <div className="card-header">
        <span className="badge badge-student" style={{ fontSize: "0.8rem", marginBottom: "0.5rem" }}>
          Candidate Portal
        </span>
        <h2 className="card-title">🎓 Student Sign In</h2>
        <p className="card-description">Access your scheduled exams & performance reports.</p>
      </div>
