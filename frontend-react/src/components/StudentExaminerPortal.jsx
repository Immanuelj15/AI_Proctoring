...
export default function StudentExaminerPortal({ onLogin, onRegister }) {
  ...
  return (
    <div style={{ maxWidth: '600px', margin: '0 auto' }}>
      <div class="glass-card">
        {/* Tab Selector */}
        <div class="tab-group" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '0.25rem' }}>
          <button
            class={`tab-btn ${activeTab === 'student-login' ? 'active' : ''}`}
            onClick={() => { setActiveTab('student-login'); setEmail(''); setPassword(''); }}
            style={{ fontSize: '0.85rem', padding: '0.65rem 0.25rem' }}
          >
            🎓 Student Login
          </button>
          <button
          ...
          <form onSubmit={(e) => handleLoginSubmit(e, 'student')}>
            <div class="card-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div>
                ...
                <p class="card-description">Access your scheduled examinations and results.</p>
              </div>
          ...
          <form onSubmit={(e) => handleLoginSubmit(e, 'examiner')}>
            <div class="card-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div>
                ...
                <p class="card-description">Manage question banks, exams, and candidate results.</p>
              </div>
        ...
        {activeTab === 'register' && (
          <form onSubmit={handleRegisterSubmit}>
            ...
            <div class="form-group">
              ...
              <div class="role-options" style={{ gridTemplateColumns: 'repeat(2, 1fr)' }}>
                <div>
                  <input
                    type="radio"
                    id="role-student"
